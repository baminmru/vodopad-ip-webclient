...
Workbook = Ext.extend(Object, {
  ...
  constructor: function(config) {
    ...
    Ext.apply(this, config, {
       ...
       * @type String
       * The colour of border to use for each Cell  #e4e4e4
       */
  ...
  addStripedStyles: function() {
    ...
    Ext.each(['even', 'odd','none'], function(parentStyle) {
	...
	this.addChildNumberFormatStyle("none", "dcell" , "dd/mm/yyyy");
	this.addChildNumberFormatStyle("none", "hcell" , "dd/mm/yyyy\ hh");
	this.addChildNumberFormatStyle("none", "tcell" , "dd/mm/yyyy\ hh:mm:ss");
